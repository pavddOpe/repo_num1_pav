...
class TestLoginPage(unittest.TestCase):
    ...
    def test_log_in_to_the_system(self):
        ...
        self.user_login.do_login('user07@getnada.com', 'Test-1234')  # login to the system
    ...
    def test_empty_password(self):
        self.user_login.do_login('user06@getnada.com', '')  # login to the system with empty password
        self.user_login.empty_password_check_message()  # check error message
        self.user_login.title_of_page()  # check that user stays on the login page
        time.sleep(3)

    def test_log_out(self):
        self.user_login.do_login('user08@getnada.com', 'Test-1234')  # login to the system
        self.dashboard_page.title_of_page()  # check if the title of the opened page is correct
    ...
    def test_remind_password(self):
        ...
        self.user_login.type_to_email('user03@getnada.com')  # enter email
